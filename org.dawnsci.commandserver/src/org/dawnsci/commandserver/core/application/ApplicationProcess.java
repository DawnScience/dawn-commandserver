...
public class ApplicationProcess {
	...
	public ApplicationProcess(File propertiesFile) throws Exception {
		...
		this.sysProps = Consumer.loadProperties(new HashMap<String, String>(7), propertiesFile.getAbsolutePath());
		this.propertiesFile = propertiesFile;
		this.progArgs = new HashMap<String,String>(1);
		progArgs.put("properties", propertiesFile.getAbsolutePath());
	}
